...
export const carregarmessages = (cdr) => {
  ...
  export const changeStatusQueue = (status) => {
    return (dispatch) => {
        dispatch(change_status_queue(status))
    };
  }
...
export const change_status_queue       = (todos) => ({ type: ClienteDetailsActionTypes.CHANGE_STATUS_QUEUE, todos })
