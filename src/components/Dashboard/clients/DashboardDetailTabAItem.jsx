...
const DashboardDetailTabAItem = () => {
  return (
    <a href="?page=dashboard-client-details" className="table-card__body__row">
        ...
        <div className="user-info">
          ...
          <div className="user-info__text">
            <div className="user-info__text__title">
              <div className="user-info__text__title__name">Mateus Souza</div>
            </div>
      ...
      <div className="table-card__item table-card__item-4">Vendas</div>
      <div className="table-card__item table-card__item-5">01:43:52</div>
      <div className="table-card__item table-card__item-6">Fila</div>
      <div className="table-card__item table-card__item-7">01:43:52</div>
      <div className="table-card__item table-card__item-8">Ocioso</div>
      <div className="table-card__item table-card__item-9">
        Matheus Souza Santos
      </div>
      <div className="table-card__item table-card__item-10">01:43:52</div>
    </a>
  );
};
