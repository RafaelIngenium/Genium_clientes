...
export const connection_platform = {
  ip_intern: "cloud.ingweb.com.br", // IP interno de conexão com backend
  ip_extern: "cloud.ingweb.com.br", // IP externo de conexão com backend
  ...
  ip_apache_view_intern: "cloud.ingweb.com.br", // IP interno de conexão com o apache para visualização e reprodução de arquivos
  port_apache_view_intern: "80", // Porta interna de conexão com o apache para visualização e reprodução de arquivos
  ip_apache_view_extern: "cloud.ingweb.com.br", // IP externo de conexão com o apache para visualização e reprodução de arquivos
  port_apache_view_extern: "80", // Porta externa de conexão com o apache para visualização e reprodução de arquivos
  ip_socket_intern: "cloud.ingweb.com.br", // IP interno de conexão com WebSocket(IMSDN)
  ip_socket_extern: "cloud.ingweb.com.br", // IP externo de conexão com WebSocket(IMSDN)
